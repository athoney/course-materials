...
func TestOpenPort(t *testing.T){
    ...
    got, _ := PortScanner(1, 1024) // Currently function returns only number of open ports
...
func TestTotalPortsScanned(t *testing.T){
    ...
    open, closed := PortScanner(1, 1024) // Currently function returns only number of open ports
	got := open + closed
